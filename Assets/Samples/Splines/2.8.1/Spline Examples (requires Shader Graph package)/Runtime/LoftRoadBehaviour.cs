...
namespace Unity.Splines.Examples
{
    ...
    public class LoftRoadBehaviour : MonoBehaviour
    {
        ...
        [SerializeField] int _selectedMaterialIndex;
        ...
        public Mesh LoftMesh
        {
            get
            {
                ...
                if (_materials != null && _selectedMaterialIndex >= 0 && _selectedMaterialIndex < _materials.Length)
                    renderer.sharedMaterial = _materials[_selectedMaterialIndex];
